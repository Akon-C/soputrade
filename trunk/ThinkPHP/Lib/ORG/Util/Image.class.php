...
{//类定义开始
     ...
     * @return void
     +----------------------------------------------------------
     */
    static function thumb($image,$thumbname='',$type='',$maxWidth=200,$maxHeight=200,$interlace=true,$suffix='_thumb')
    {
        // 获取原图信息
        $info  = Image::getImageInfo($image);
         ...
         if($info !== false) {
            ...
            $thumbname  = empty($thumbname)? substr($image,0,strrpos($image, '.')).$suffix.'.'.$type : $thumbname;
...
//        @imagestring($im, 5, 5, 3, $randval, $stringColor);
    ...
    static public function water($source,$water,$waterPos=9,$savename=null,$alpha=80)
    {
        //检查文件是否存在
        if(!file_exists($source)){
			//echo "source::file_exists!";
			return false;
		}
		if(!file_exists($water)){
			//echo "water::file_exists!";
			return false;
		}
	...
	*/
	function imageWaterMark($groundImage,$waterPos=0,$waterImage="",$waterText="",$textFont=9,$textColor="#FF0000")
	{
		$isWaterImage = FALSE;
