...
class Payeasy3D {
	...
	function submit_post() {
		echo "<html>";
		echo "<head><title>Processing Payment...</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\n";
		/*print <<<js
...
function check_country(){
	var payment=document.pay_form;
			
			if(payment.country.value==""){
				alert('please select you country');
				return false;
			}else{
				payment.v_shipcountry.value=payment.country.value;
			}
			if(payment.country.value==840 && payment.us_state.value==""){
				alert('please select you state');
				return false;
			}else if(payment.country.value==124 && payment.ca_state.value==""){
				alert('please select you state');
				return false;
			}else{
				if(payment.us_state.value != ''){
				payment.v_shipstate.value=payment.us_state.value;
				}else{
				payment.v_shipstate.value=payment.ca_state.value;
				}
			}
}
</script>
js;*/
		...
		echo "<input type=\"hidden\" name=\"v_shipstate\" value=\"\"/>\n";
		echo "<input type=\"hidden\" name=\"v_shipcountry\" value=\"\"/>\n";

		//echo "<center><br/><br/>If you are not automatically redirected to ";
		//echo "PayEasy within 5 seconds...<br/><br/>\n";
		/*print <<<country
		<table align="center">
		<tr id="country"><td>Country:</td>
		<td>
...
<option value="894">Republic of Zambia </option>
	...
	<tr id="state" style="display:none"><td>state:</td><td>
...
<option value="WY">Wyoming</option>
	...
	<tr id="state2" style="display:none"><td>state:</td><td>
...
country;*/
		//echo "<center><input type=\"submit\" value=\"Pay by PayEasy\" onclick='return check_country()';></center>\n";
		echo "<center><input type=\"submit\" value=\"Pay by PayEasy\" ></center>\n";
