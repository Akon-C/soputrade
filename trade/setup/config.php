...
$conf=array(
	/* 基本设置 */
	'APP_NAME'=>"SOP外贸易",			//项目名字
	'APP_TITLE'=>"SOP外贸易网店系统",			//项中文说明
	'APP_ROOT'=>"../",			//你想安装的路径,相对路径
	'APP_INFO'=>array(			//本信息会出现在安装后的最后一页,可以扩展增加
		array('title'=>'项目网址:','info'=>'<a href="http://code.google.com/p/soputrade/" target="_blank" >http://code.google.com/p/soputrade/</a>'),
		array('title'=>'开发人员:','info'=>'连锦先,许正楠,吴煜'),
		array('title'=>'案例展示:','info'=>'<a href="http://shop.pcicn.com" target="_blank" >http://shop.pcicn.com</a>'),
		array('title'=>'更新日志:','info'=>'<a href="http://code.google.com/p/soputrade/updates/list" target="_blank" >http://code.google.com/p/soputrade/updates/list</a>'),
	...
	'APP_SQL'=>array(
		...
		array(
			...
			'SQL_INFO'=>"安装SOP外贸易 基本的数据结构",		//SQL说明
			'SQL_KEY'=>"{key}"				//SQL中可变的变量,如前缀等,用于替换
			),
		/* 设置*/ 
		array(
			'SQL_FILE'=>"./sql/base.sql",		//SQL文件
			'SQL_INFO'=>"安装SOP外贸易基本的基础数据",			//SQL说明
			'SQL_KEY'=>"{key}"				//SQL中可变的变量,如前缀等,用于替换
			)
	),
	...
	'COPYRIGHT'=>array(
		...
		/* 设置 */
		array(
			'TITLE'=>"SOP外贸易 说明",					//版权文件
			'LOGO'=>"http://www.0594trade.com/images/wind/logo.png",	//根文件夹重命名
