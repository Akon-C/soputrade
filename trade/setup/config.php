...
$conf=array(
	/* 基本设置 */
	'APP_NAME'=>"EpJob 0.1 bate",			//项目名字
	'APP_TITLE'=>"按效果付费的，基于UC的易聘人才网站系统",			//项中文说明
	'APP_ROOT'=>"../",			//你想安装的路径,相对路径
	'APP_INFO'=>array(			//本信息会出现在安装后的最后一页,可以扩展增加
		array('title'=>'项目网址:','info'=>'<a href="http://epjob.cn" target="_blank" >易聘人才</a>'),
		array('title'=>'开发人员:','info'=>'翁志刚，许正楠，鲍家顺，黄雄'),
		array('title'=>'案例展示:','info'=>'<a href="http://job.0594.com" target="_blank" >莆田人才网</a>'),
		array('title'=>'更新日志:','info'=>'<a href="http://epjob.cn/Change" target="_blank" >http://epjob.cn/Change</a>'),
	...
	'APP_SQL'=>array(
		/* 设置 */
		array(
			'SQL_FILE'=>"./sql/epjob.sql",		//SQL文件
			'SQL_INFO'=>"安装epjob基本的数据结构",		//SQL说明
			'SQL_KEY'=>"{key}"				//SQL中可变的变量,如前缀等,用于替换
			),
		/* 设置*/ 
		/*array(
			'SQL_FILE'=>"./sql/base.sql",		//SQL文件
			'SQL_INFO'=>"安装Thinkphp examples基本的基础数据",			//SQL说明
			'SQL_KEY'=>"{key}"				//SQL中可变的变量,如前缀等,用于替换
			)*/
	),
	...
	'COPYRIGHT'=>array(
		...
		array(
			'TITLE'=>"易聘人才  说明",					//版权文件
			'LOGO'=>"http://job.0594.com/Tpl/default/Public/2009css/rc0594logo.gif",	//根文件夹重命名
			'COPY_TYPE'=>"Apache2",						//请对照$conf_copyright
			'SHOW_TYPE'=>0,								//0只显示公共的版本,1只显示自己版权,2两者都显示.选1和2需要设置'COPY_TEXT'//功能无效
			'COPY_TEXT'=>"本版权归莆田市易莆网络信息技术有限公司所有，非个人组织不得用于商业行为！",						//只有上面'SHOW_TYPE'不为0时需要设置,支持HTML,暂时不支持外部文件引用
			),
		/* 设置 */
		/*array(
			'TITLE'=>"THINKPHP版权说明",
...
$app_check=array(
	...
	'check_globals'=>array('ischeck'=>true,'title'=>'自定义全局变量 (register_globals)','type'=>1,'value'=>true),
	...
	'check_smtp'=>array('ischeck'=>true,'title'=>'SMTP支持','type'=>1,'value'=>true),
	'check_iconv'=>array('ischeck'=>true,'title'=>'Iconv编码转换','type'=>1,'value'=>true),
	//'check_stocket'=>array('ischeck'=>true,'title'=>'stocket为可用','type'=>1,'value'=>true),
	//'check_online'=>array('ischeck'=>true,'title'=>'安装时主机必须需要接入互联网','type'=>1,'value'=>true),
);
