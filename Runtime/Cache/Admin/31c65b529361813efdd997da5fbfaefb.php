		...
		<div id="content" class="box">
            ...
            <table width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr >
				    ...
				    <td style="text-align:left" id="classname" ><?php if(!empty($vo['smallimage'])): ?><a class="preview" href="../<?php echo ($vo['smallimage']); ?>"><?php echo ($vo["name"]); ?></a><?php else: ?><?php echo ($vo["name"]); ?><?php endif; ?></td>
                    ...
                    <td style="text-align:center" ><a href="<?php echo u('Products/attredit',array('id'=>$vo['id']));?>">属性编辑</a>&nbsp;|&nbsp;<a href="<?php echo u('Products/edit',array('id'=>$vo['id']));?>">编辑</a>&nbsp;|&nbsp;<a name="del_<?php echo ($vo["id"]); ?>"  href="<?php echo u('Products/Delete',array('id'=>$vo['id']));?>" >移除</a></td>
